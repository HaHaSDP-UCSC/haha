...
Include dependency graph for hal\+\_\+usart\+\_\+sync.\+h\+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=350pt]{hal__usart__sync_8h__incl}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{hal__usart__sync_8h__dep__incl}
\end{center}
\end{figure}
\subsection*{Classes}
