...
Include dependency graph for utils\+\_\+ringbuffer.\+h\+:
\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=350pt]{utils__ringbuffer_8h__incl}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{utils__ringbuffer_8h__dep__incl}
\end{center}
\end{figure}
\subsection*{Classes}
